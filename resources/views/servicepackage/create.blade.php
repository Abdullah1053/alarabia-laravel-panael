            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            {{ Form::label('name', __('messages.select_provider',[ 'select' => __('messages.provider') ]).' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                            <br />
                            {{ Form::select('provider_id', [ optional($servicepackage->providers)->id => optional($servicepackage->providers)->display_name ], optional($servicepackage->providers)->id, [
                                    ...
                                    'id' => 'provider_id',
                                    'required',
                                    'data-placeholder' => __('messages.select_provider',[ 'select' => __('messages.provider') ]),
                        ...
                        <div class="form-group col-md-4 d-none" id="select_category">
                            {{ Form::label('name', __('messages.select_category',[ 'select' => __('messages.category') ]).' <span class="text-danger">*</span>',['class'=>'form-control-label',],false) }}
                            <br />
                            {{ Form::select('category_id', [optional($servicepackage->category)->id => optional($servicepackage->category)->name], optional($servicepackage->category)->id, [
                                ...
                                'id' => 'category_id',
                                'data-placeholder' => __('messages.select_category',[ 'select' => __('messages.category') ]),
                                'data-ajax--url' => route('ajax-list', ['type' => 'category']),
                            ]) }}
                        </div>
                        <div class="form-group col-md-4 d-none" id="select_subcategory">
                            {{ Form::label('name', __('messages.select_subcategory',[ 'select' => __('messages.subcategory') ]).' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                            <br />
                            {{ Form::select('subcategory_id', [optional($servicepackage->subcategory)->id => optional($servicepackage->subcategory)->name], optional($servicepackage->subcategory)->id, [
                                ...
                                'id' => 'subcategory_id',
                                'data-placeholder' => __('messages.select_subcategory',[ 'select' => __('messages.subcategory') ]),
                               
                            ]) }}
                        </div>
                        <div class="form-group col-md-4">
                            {{ Form::label('name', __('messages.select_service',[ 'select' => __('messages.service') ]).' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                            <br />
                            {{ Form::select('service_id[]', [], old('service_id'), [
                                'class' => 'select2js form-group service_id',
                                'id' =>'service_id',
                                'multiple' => 'multiple',
                                'data-placeholder' => __('messages.select_service',[ 'select' => __('messages.service') ]),
                                'required' => 'required',
                            ]) }}
                        </div>
                        <div class="form-group col-md-4">
