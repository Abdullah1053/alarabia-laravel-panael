...
$menu->services->add('<span>'.trans('messages.user_service_list',['form' => trans('messages.service')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'service.user-service-list'])
...
$menu->services->add('<span>'.trans('messages.package_list_form_title',['form' => trans('messages.service_package')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'servicepackage.index'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
</svg>')
...
$menu->provider->add('<span>'.__('messages.provider_list',['form' => __('messages.provider_list')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'provider.index'])
->data('permission', 'provider list')
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
</svg>')
...
$menu->provider->add('<span>'.__('messages.providerdocument',['form' => __('messages.providerdocument')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'providerdocument.index'])
...
$menu->provider->add('<span>'.__('messages.provider_payout',['form' => __('messages.provider_payout')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'providerpayout.index'])
...
$menu->provider->add('<span>'.__('messages.providertype',['form' => __('messages.providertype')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'providertype.index'])
...
$menu->provider->add('<span>'.__('messages.provider_address',['form' => __('messages.provider_address')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'provideraddress.index'])
...
// $menu->provider->add('<span>'.__('messages.subscribe',['form' => __('messages.subscribe')]).'</span>', ['class' => 'sidebar-layout' ,'route' => ['provider.pending','subscribe']])
// ->data('role', 'admin')
// ->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$menu->handyman->add('<span>'.__('messages.handyman',['form' => __('messages.handyman')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'handyman.index'])
->data('permission', 'handyman list')
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
</svg>')
...
$menu->handyman->add('<span>'.__('messages.handyman_earning',['form' => __('messages.handyman_earning')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'handymanEarning'])
->data('role', 'provider')
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$menu->handyman->add('<span>'.__('messages.handymantype',['form' => __('messages.handymantype')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'handymantype.index'])
...
$menu->handyman->add('<span>'.__('messages.handyman_payout',['form' => __('messages.handyman_payout')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'handymanpayout.index'])
...
$menu->add('<span>'.__('messages.customer',['form' => trans('messages.customer') ]).'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.customer').'</span></span>', ['route' => 'user.index'])
...
$menu->add('<span>'.__('messages.all_user',['form' => trans('messages.all_user')]).'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.users').'</span></span>', ['route' => ['user.all','all']])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.75 7.3125C3.995 7.3125 0.5 8.19 0.5 9.9375V11.25H11V9.9375C11 8.19 7.505 7.3125 5.75 7.3125ZM2.255 9.75C2.885 9.315 4.4075 8.8125 5.75 8.8125C7.0925 8.8125 8.615 9.315 9.245 9.75H2.255ZM5.75 6C7.1975 6 8.375 4.8225 8.375 3.375C8.375 1.9275 7.1975 0.75 5.75 0.75C4.3025 0.75 3.125 1.9275 3.125 3.375C3.125 4.8225 4.3025 6 5.75 6ZM5.75 2.25C6.3725 2.25 6.875 2.7525 6.875 3.375C6.875 3.9975 6.3725 4.5 5.75 4.5C5.1275 4.5 4.625 3.9975 4.625 3.375C4.625 2.7525 5.1275 2.25 5.75 2.25ZM11.03 7.3575C11.9 7.9875 12.5 8.8275 12.5 9.9375V11.25H15.5V9.9375C15.5 8.4225 12.875 7.56 11.03 7.3575ZM10.25 6C11.6975 6 12.875 4.8225 12.875 3.375C12.875 1.9275 11.6975 0.75 10.25 0.75C9.845 0.75 9.47 0.8475 9.125 1.0125C9.5975 1.68 9.875 2.4975 9.875 3.375C9.875 4.2525 9.5975 5.07 9.125 5.7375C9.47 5.9025 9.845 6 10.25 6Z" fill="#6C757D" />
</svg>')
->nickname('user')
...
$menu->add(__('messages.Transactions'), ['class' => 'category-main'])->data('permission', ['tax list','payment list','earning list']);
...
$menu->add(trans('نشر وظيفة'), ['class' => 'category-main'])->data('permission', ['post job']);

$menu->add('<span>'.trans('نشر وظيفة',['form' => trans('نشر وظيفة')]).'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.post_job').'</span></span>', ['route' => 'post-job-request.index'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$menu->add(__('التقيممات'), ['class' => 'category-main'])->data('permission', ['user rating list','handyman rating list']);

$menu->add('<span>'.trans('messages.user_ratings',['form' => trans('messages.user_ratings')]).'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.user_ratings').'</span></span>', ['route' => 'booking-rating.index'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$menu->add('<span>'.trans('messages.handyman_ratings',['form' => trans('messages.handyman_ratings')]).'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.handyman_ratings').'</span></span>', ['route' => 'handyman-rating.index'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.94,10.179l-2.437-0.325l1.62-7.379c0.047-0.235-0.132-0.458-0.372-0.458H5.25c-0.241,0-0.42,0.223-0.373,0.458l1.634,7.376L4.06,10.179c-0.312,0.041-0.446,0.425-0.214,0.649l2.864,2.759l-0.724,3.947c-0.058,0.315,0.277,0.554,0.559,0.401l3.457-1.916l3.456,1.916c-0.419-0.238,0.56,0.439,0.56-0.401l-0.725-3.947l2.863-2.759C16.388,10.604,16.254,10.22,15.94,10.179M10.381,2.778h3.902l-1.536,6.977L12.036,9.66l-1.655-3.546V2.778z M5.717,2.778h3.903v3.335L7.965,9.66L7.268,9.753L5.717,2.778zM12.618,13.182c-0.092,0.088-0.134,0.217-0.11,0.343l0.615,3.356l-2.938-1.629c-0.057-0.03-0.122-0.048-0.184-0.048c-0.063,0-0.128,0.018-0.185,0.048l-2.938,1.629l0.616-3.356c0.022-0.126-0.019-0.255-0.11-0.343l-2.441-2.354l3.329-0.441c0.128-0.017,0.24-0.099,0.295-0.215l1.435-3.073l1.435,3.073c0.055,0.116,0.167,0.198,0.294,0.215l3.329,0.441L12.618,13.182z" fill="#6C757D" />
</svg>')
...
$menu->document->add('<span>'.__('messages.document',['form' => trans('messages.document') ]).'</span>', [ 'class' => 'sidebar-layout' , 'route' => ['document.index']])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
</svg>')
->data('permission', 'document list')
...
// $menu->frontend_setting->add('<span>'.__('messages.app_download',['form' => __('messages.app_download')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'app-download'])
// ->data('role', 'admin')
// ->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$menu->account_setting->add('<span>'.__('messages.role',['form' => __('messages.role')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'role.index'])
...
$menu->account_setting->add('<span>'.__('messages.permission',['form' => __('messages.permission')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'permission.index'])
...
$name= '';
if(  ucfirst(str_replace("_"," ",auth()->user()->user_type)) == "Provider"   ){
    $name = 'مقاول';
}elseif ( ucfirst(str_replace("_"," ",auth()->user()->user_type)) == "admin" ) 
{
    $name = 'ادمن';
}else {
    $name = 'مستخدم';
...
<div class="iq-sidebar sidebar-default">
    <div class="iq-sidebar-logo">
        <a href="{{ route('home') }}" class="header-logo">
            ...
            <span class="white-space-no-wrap">{{  $name  }}</span>
        </a>
