                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ Form::label('subcategory_id', __('messages.select_subcategory',[ 'select' => __('messages.select_subcategory') ]),['class'=>'form-control-label'],false) }}
                                <br />
                                {{ Form::select('subcategory_id', [], [
                                        'class' => 'select2js form-group subcategory_id',
                                        'data-placeholder' => __('messages.select_subcategory',[ 'select' => __('messages.select_subcategory') ]),
                                    ]) }}
                            </div>
                            ...
                            @endif
                            {{-- <div class="form-group col-md-4">
                                {{ Form::label('name', __('messages.provider_address',[ 'select' => __('messages.provider_address') ]),['class'=>'form-control-label'],false) }}
                                <br />
                                {{ Form::select('provider_address_id[]', [], old('provider_address_id'), [
                                        ...
                                        'multiple' => 'multiple',
                                        'data-placeholder' => __('messages.provider_address',[ 'select' => __('messages.provider_address') ]),
                                    ]) }}
