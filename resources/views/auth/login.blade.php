                      ...
                      <div class="row">
                         ...
                         <div class="col-lg-12 mt-2">
                            <div class="form-group">
                               ...
                               <input class="form-control" type="password" placeholder="{{ __('auth.login_password',['name' => __('auth.login_password') ]) }}" name="password"  required autocomplete="current-password">
                               <small class="help-block with-errors text-danger"></small>
                            </div>
                         </div>                              
                      </div>
